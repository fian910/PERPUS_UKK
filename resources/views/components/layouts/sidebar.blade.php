<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('format') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-list-ul text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Kelola Format</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('transaksi') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-file-invoice-dollar text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Kelola Transaksi</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('penerbit') }}">
                    ...
                    <span class="nav-link-text ms-1">Kelola Penerbit</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('pengarang') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-at text-dark"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('anggota') }}">
                    ...
                    <span class="nav-link-text ms-1">Kelola Anggota</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('jenis_anggota') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-users text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Kelola Jenis Anggota</span>
                </a>
            </li>
            <li class="nav-item mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('perpus') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-book-bookmark text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Kelola Perpustakaan</span>
                </a>
            </li>
        </ul>
    </div>
